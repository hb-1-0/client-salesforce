...
class SalesforceClient {
  ...
  authenticate() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const token = yield (0, oauth_1.authenticate)(
          this.clientId,
          this.clientSecret,
          this.username,
          this.password,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const response = yield axios_1.default.get(
          `${
            (_a = this.authToken) === null || _a === void 0
              ? void 0
              : _a.instance_url
          }/services/data/v62.0/query`,
          {
            headers: {
              Authorization: `Bearer ${
                (_b = this.authToken) === null || _b === void 0
                  ? void 0
                  : _b.access_token
              }`,
            },
        ...
        const response = yield axios_1.default.post(
          `${
            (_a = this.authToken) === null || _a === void 0
              ? void 0
              : _a.instance_url
          }/services/data/v62.0/sobjects/${objectType}`,
          data,
          {
            headers: {
              Authorization: `Bearer ${
        ...
        const response = yield axios_1.default.patch(
          `${
            (_a = this.authToken) === null || _a === void 0
              ? void 0
              : _a.instance_url
          }/services/data/v62.0/sobjects/${objectType}/${objectId}`,
          data,
          {
            headers: {
              Authorization: `Bearer ${
  ...
  delete(objectType, objectId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        yield this.ensureToken();
        const response = yield axios_1.default.delete(
          `${
            (_a = this.authToken) === null || _a === void 0
              ? void 0
              : _a.instance_url
